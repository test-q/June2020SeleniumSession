...
public class WebDriverBasics {
	...
	public static void main(String[] args) {
		/* Browser Company upgrade there browser and version change continuously hence selenium facing Compatibility issues so it is decided every browser company  
		   will provide one executable file ie .exe and you have configure this .exe file in your code in the form of System.setProperty and than launch the browser
		   and this is the major change selenium 2 to selenium 3
		 */
...
//		Hence we are doing Top casting -> Create object of child class can be referred by Interface reference variable
		WebDriver driver = new ChromeDriver();//ChromeDriver is class which is extending RemoteWebDriver and RemoteWebDriver is implementing WebDriver interface
											  ...
											  //If you not written System.setProperty line than it will throw the "ExecutionException" error
